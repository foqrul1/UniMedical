...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    public UserAdapter(Context mContext, List<Call_User_Model> mUsers, boolean ischat){
        this.mUsers = mUsers;
